              ...
              <div class="card-body">
                <form method="POST" action="#" class="needs-validation" novalidate="">
                  <div class="form-group">
                    <label for="np.telp" class="ion-ios-telephone" data-pack="ios" data-tags="oldschool, call">No. Telp</label>
                    <input id="no.telp" type="number" class="form-control" name="no.telp" tabindex="1" required autofocus>
